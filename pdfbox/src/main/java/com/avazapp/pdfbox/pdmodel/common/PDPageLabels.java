...
public class PDPageLabels implements COSObjectable
{
     ...
     * {@link com.avazapp.pdfbox.pdmodel.PDDocumentCatalog#setPageLabels(PDPageLabels)}.
     * </p>
     * 
     * @param document
     *            The document the page label dictionary is created for.
     * @see com.avazapp.pdfbox.pdmodel.PDDocumentCatalog#setPageLabels(PDPageLabels)
     */
