package com.avazapp.pdfbox.pdmodel.font.encoding;

import com.avazapp.fontbox.afm.CharMetric;
...
public class Type1Encoding extends Encoding
{
     ...
     */
    public static Type1Encoding fromFontBox(com.avazapp.fontbox.encoding.Encoding encoding)
    {
