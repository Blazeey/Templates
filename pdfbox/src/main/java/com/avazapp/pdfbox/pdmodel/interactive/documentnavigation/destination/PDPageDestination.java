package com.avazapp.pdfbox.pdmodel.interactive.documentnavigation.destination;
...
public abstract class PDPageDestination extends PDDestination
{
     ...
     * @see com.avazapp.pdfbox.pdmodel.interactive.documentnavigation.outline.PDOutlineItem
