 ...
 */
package com.avazapp.fontbox.cmap;
...
public class CMapParser
{
    ...
    protected InputStream getExternalCMap(String name) throws IOException
    {
    	if(PDFBoxResourceLoader.isReady()) {
    		return PDFBoxResourceLoader.getStream("com.avazapp/fontbox/resources/cmap/" + name);
    	}
    	
    	// Fallback
        URL url = getClass().getResource("/com.avazapp/fontbox/resources/cmap/" + name);
        if (url == null)
        {
