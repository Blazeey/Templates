package com.blazeey.templates.Button;
...
/**
 * Custom view replication the functionality of segmented button in iOS application
 */
public class SegmentedButton extends LinearLayout {
    ...
    public SegmentedButton(final Context context, AttributeSet attr) {
        ...
        try {
            textColor = typedArray.getColor(R.styleable.SegmentedButton_text_color, getResources().getColor(R.color.colorPrimary));
            ...
            buttonBackgroundSelected = typedArray.getColor(R.styleable.SegmentedButton_selected_button_bg, getResources().getColor(R.color.colorPrimary));
            ...
            backgroundColor = typedArray.getColor(R.styleable.SegmentedButton_border_color, getResources().getColor(R.color.colorPrimary));
    ...
    /**
     * Set background to an option
     * @param i option whose background has to be changed
    ...
    /**
     * Set the option changed listener
     * @param onOptionChangedListener object implementing OnOptionChangedListener
     */
    ...
    /**
     * Set the selection
     * @param position index of the option to be selected
     */
